...
1. arrowskm: draw direction arrows along the track every N kilometers (decimals allowed, e.g., arrowskm="0.5")
...
= 2.0.1 =
General (mod by ktb):
- Elevation maps for high slopes
